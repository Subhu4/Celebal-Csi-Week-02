...
Add a task if none are present.
...
Use the filter dropdown to select "All", "Completed", and "Incomplete".
Expected Outcome:
...
Use the sort dropdown to select sorting criteria such as "Task Name", "Creation Date", or "Completion Status".
6. Data Persistence
Steps:
